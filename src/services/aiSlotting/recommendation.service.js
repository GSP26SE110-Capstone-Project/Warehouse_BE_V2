...
export async function recommendSlotForLpn(lpnId, { warehouseId, inboundRequestId } = {}) {
  ...
  for (const bin of rawCandidates) {
    ...
    scored.push({
      ...
      recommendedRackId: bin.rackId,
      recommendedRackLevelId: bin.rackLevelId,
  ...
  return {
    ...
    recommendedRackId: best.recommendedRackId,
    recommendedRackLevelId: best.recommendedRackLevelId,
    recommendedBinId: best.recommendedBinId,
    zoneCode: best.zoneCode,
    rackCode: best.rackCode,
    ...
    alternatives: alternatives.map((alt) => ({
      ...
      recommendedRackId: alt.recommendedRackId,
      recommendedRackLevelId: alt.recommendedRackLevelId,
      recommendedBinId: alt.recommendedBinId,
      zoneCode: alt.zoneCode,
      rackCode: alt.rackCode,
      levelNumber: alt.levelNumber,
      binCode: alt.binCode,
      score: alt.score,
      reasons: alt.reasons,
    })),
