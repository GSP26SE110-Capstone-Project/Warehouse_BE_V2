...
/** SHARED_STORAGE ước tính HĐ — giá box/tháng (= giá ngày × 30) */
export const STORAGE_BOX_MONTH_PRICE_BY_BOX_TYPE = Object.freeze({
  SMALL: STORAGE_BOX_DAY_PRICE_BY_BOX_TYPE.SMALL * DAYS_PER_BILLING_MONTH,
  MEDIUM: STORAGE_BOX_DAY_PRICE_BY_BOX_TYPE.MEDIUM * DAYS_PER_BILLING_MONTH,
  LARGE: STORAGE_BOX_DAY_PRICE_BY_BOX_TYPE.LARGE * DAYS_PER_BILLING_MONTH,
  EXTRA: STORAGE_BOX_DAY_PRICE_BY_BOX_TYPE.EXTRA * DAYS_PER_BILLING_MONTH,
});
