...
const MIGRATION_FILES = [
  ...
  'scripts/sql/add_transporter_profile.sql',
  'scripts/sql/add_inbound_pickup_location.sql',
  'scripts/sql/inbound_in_transit_status.sql',
  'scripts/sql/outbound_delivery_mode.sql',
  ...
  'scripts/sql/invoice_operational_refs.sql',
  'scripts/sql/billing_reminder_logs.sql',
];
