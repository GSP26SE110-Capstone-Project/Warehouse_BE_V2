...
const models = [
  ...
  },
  {
    ...
    schema: {
      ...
      estimatedBoxCount: n(),
      estimatedVolume: d(),
      averageStorageDays: n(),
      estimatedInboundPerWeek: n(),
      estimatedOutboundPerWeek: n(),
      requiresFastPicking: b({ default: false }),
      requiresPremiumStorage: b({ default: false }),
      notes: s(),
      suggestedZoneType: en(),
      suggestedRackType: en(),
      expectedStartDate: dt({ default: undefined, required: false }),
      expectedEndDate: dt({ default: undefined, required: false }),
      status: en(),
